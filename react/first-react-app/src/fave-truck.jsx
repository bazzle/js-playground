...
function FaveTruck(){
    ...
    return(
        ...
        <div className="fave-truck">
            <form className="fave-truck__form">
                <div className="fave-truck__form__section">
                    <label htmlFor="truck-make">Truck manufacturer</label>
                    <input id="truck-make" type="text" onChange={handleChangeMake} />
                </div>
                <div className="fave-truck__form__section">
                    <label htmlFor="truck-make">Truck model</label>
                    <input id="truck-make" type="text" onChange={handleChangeModel} />
                </div>
            </form>
